...
echo "==================================="
echo "Building dev-toolchain (built-in Docker daemon)"
echo "==================================="
...
echo "     ${SCRIPT_DIR}/tests/run-tests.sh"
echo ""
...
echo "     docker exec -it dev-test install-brew-tools.sh --help"
echo ""
echo "  5. Clean up:"
echo "     docker compose -f ${SCRIPT_DIR}/tests/docker-compose.test.yml down"
echo ""
